...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%            
                \begin{minipage}[t]{0.4\textwidth}
                    ...
                    \frame{\includegraphics[scale=0.3]{TR_Team_A.PNG}}
                \end{minipage}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% End %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    \begin{minipage}[t]{\textwidth}
        \begin{minipage}[t]{0.3\textwidth}
            \frame{\includegraphics[scale=0.25]{Receiving_1.PNG}} 
            \captionof{figure}{Try Ball Obstructed by placing flap.} \label{Recieving_1}
        \end{minipage}
        \hfil
        \begin{minipage}[t]{0.3\textwidth}
            \frame{\includegraphics[scale=0.25]{Receiving_2.PNG}} 
            \captionof{figure}{Putting try ball in try spot.} \label{Recieving_2}
        \end{minipage}
        \hfil
        \begin{minipage}[t]{0.3\textwidth}
            \frame{\includegraphics[scale=0.25]{PR_Team_A.PNG}} 
