        ...
        \subsubsection{Working}
            ...
            \begin{minipage}[t]{\textwidth}
                \begin{minipage}[b]{0.3\textwidth}
                    \frame{\includegraphics[scale=0.25]{Piston_kicking_1.PNG}} 
                    \captionof{figure}{Initial Positon.} \label{Piston_Kicking_1}
                \end{minipage}
                \hfil
                \begin{minipage}[b]{0.3\textwidth}
                    \frame{\includegraphics[scale=0.25]{Piston_kicking_2.PNG}} 
                    \captionof{figure}{Intermediate Positon.} \label{Piston_Kicking_2}
                \end{minipage}
                \hfil
                \begin{minipage}[b]{0.3\textwidth}
                    \frame{\includegraphics[scale=0.25]{Piston_kicking_3.PNG}} 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        ...
        \subsubsection{Working}       
            ...
            \begin{minipage}[t]{\textwidth}
                \begin{minipage}[b]{0.3\textwidth}
                    \frame{\includegraphics[scale=0.25]{Motor_kicking_1.PNG}} 
                    \captionof{figure}{Initial Positon.} \label{Motor_Kicking_1}
                \end{minipage}
                \hfil
                \begin{minipage}[b]{0.3\textwidth}
                    \frame{\includegraphics[scale=0.25]{Motor_kicking_2.PNG}} 
                    \captionof{figure}{Intermediate Positon.} \label{Motor_Kicking_2}
                \end{minipage}
                \hfil
                \begin{minipage}[b]{0.3\textwidth}
                    \frame{\includegraphics[scale=0.25]{Motor_kicking_3.PNG}} 
